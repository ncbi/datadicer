                ...
                var $self = $(this),
                    bindContextMenu = function () {
                        $(this.grid.hDiv).find('.ui-jqgrid-labels').contextmenu(function (e) {
                            ...
                            if (gh && gh.groupHeaders ) {
                                i = 0;
                                for (l = gh.groupHeaders.length; i < l; i++) {
                            ...
                            $menu.appendTo('body')
                                .menu({
                                    select: function (event, ui) {
                                        ...
                                        if (!isNaN(index) && index >= 0 && cmi  && $cb.length > 0) {
                                            if (toHide) {
                ...
                options = $.extend(true,
                    (this.p.iconSet === 'fontAwesome' || options.iconSet === 'fontAwesome') ? {
                        ...
                        isChecked: function ($checkbox) {
                            return $checkbox.hasClass('fa-check-square-o');
                        },
                        toCheck: function ($checkbox) {
                            $checkbox.removeClass('fa-square-o').addClass('fa-check-square-o');
                        },
                        toUnCheck: function ($checkbox) {
